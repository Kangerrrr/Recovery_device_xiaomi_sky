...
D1=$(find -name "bootable")
D2=$(find "bootable" -name "gui")

sed -i 's/value="#D34E38"/value="#000000"/g' "$D1"/recovery/gui/theme/portrait_hdpi/splash.xml
sed -i 's/value="#FF8038"/value="#000000"/g' "$D1"/recovery/gui/theme/portrait_hdpi/splash.xml
